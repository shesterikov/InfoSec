...
Данная практическая работа является прямым продолжением практической работы №2, поэтому наличие кода, связанного с хешированием паролей будет приветствоваться.
...
![Рисунок 4.1 - Главный экран Postman с успешным ответом от API](/assets/task-03/1.png)
...
![Рисунок 4.2 - cURL запрос для создания нового пользователя](/assets/task-03/2.png)
...
![Рисунок 4.3 - SQL запрос для обновления роли пользователя](/assets/task-03/3.png)
...
![Рисунок 4.4 - Успешная аутентификация с получением JWT токена](/assets/task-03/4.png)
...
8. Выполните декодирование токена с использованием сервиса [JWT Debugger](https://www.jwt.io/), убедившись, что в секции `payload` представлены `id` и `role` пользователя
   ![Рисунок 4.5 - Успешная аутентификация с получением JWT токена](/assets/task-03/5.png)
