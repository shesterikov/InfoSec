...
![Рисунок 3.1 - Главный экран Postman с успешным ответом от API](/assets/task-02/1.png)
...
![Рисунок 3.2 - cURL запрос для создания нового пользователя](/assets/task-02/2.png)
...
![Рисунок 3.3 - SQL запрос для отображения содержимого таблицы users после вставки данных](/assets/task-02/3.png)
