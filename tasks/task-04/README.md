...
![Рисунок 5.1 - Главный экран Postman с успешным ответом от API](/assets/task-04/1.png)
...
5. Удостоверьтесь, что аналогичный текст представлен во второй вкладке
   ![Рисунок 5.2 - Основной экран чата с полученным сообщением](/assets/task-04/2.png)
...
6. Удостоверьтесь, что текст пересылаемого сообщения представлен в логах socket-сервера при помощи команды `docker logs chat`
   ![Рисунок 5.3 - Логи на стороне API, отображающие пересылаемые сообщения в открытом виде](/assets/task-04/3.png)
